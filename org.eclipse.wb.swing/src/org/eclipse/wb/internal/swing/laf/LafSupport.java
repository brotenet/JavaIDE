...
public final class LafSupport {
  ...
  private static void createLAFList() {
    if (m_lafList == null) {
      ...
      rootCategory.add(new LafInfo("pgs", "PGS", PgsLookAndFeel.class.getName()));
      rootCategory.add(new LafInfo("metal", "Metal", MetalLookAndFeel.class.getName()));
      rootCategory.add(
          new LafInfo("nimbus", "Nimbus", "com.sun.java.swing.plaf.nimbus.NimbusLookAndFeel"));
...
//      }
  ...
  /**
   * Returns system default LAF. For Linux it is 'PGS' LAF because..
   *
   * @return system default LAF.
   */
  public static LafInfo getSystemDefaultLAF() {
    if (EnvironmentUtils.IS_LINUX) {
      LafInfo lafInfo = lookupLAFByID_ensureList("pgs");
